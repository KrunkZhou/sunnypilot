...
inline static std::unordered_map<std::string, ParamKeyAttributes> keys = {
    ...
    {"SentryCaptureLease", {CLEAR_ON_MANAGER_START | DONT_LOG, JSON}},
    {"SentryRuntimeCommand", {CLEAR_ON_MANAGER_START | DONT_LOG, JSON}},
    {"SentryRuntimeEnabled", {CLEAR_ON_MANAGER_START | DONT_LOG, BOOL}},
    {"SentryRuntimeStatus", {CLEAR_ON_MANAGER_START | DONT_LOG, JSON}},
    ...
    {"VehicleTelemetryState", {PERSISTENT | DONT_LOG, JSON}},
