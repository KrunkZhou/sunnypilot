...
`/data/rtzs/vehicle_telemetry/outbox.sqlite3`. Unresolved measurements and segment
...
and firmware/device restart. The SQLite database owns the ordering high-water
mark and cached readings; existing metadata is preserved when it is reopened.
