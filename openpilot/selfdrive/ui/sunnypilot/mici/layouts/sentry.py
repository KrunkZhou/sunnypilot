...
DRIVER_EXIT_STATUS = {
  ...
  "door_signal_unavailable": (
    "waiting door",
    "Waiting for door. Might be unavailable",
  ),
}
...
class SentryConsentLayoutMici(NavScroller):
  def __init__(self, icon: rl.Texture, confirm_callback):
    ...
    self._scroller.add_widgets([
      ...
      GreyBigButton("parked camera capture", "Motion captures photos."),
      GreyBigButton("upload to RTZs", "Captures upload automatically."),
      accept,
    ])
